...
#include <cstring>     //for predefined Variables
#include <string>     //for predefined Variables
#include "Define.h"     //for predefined Variables
#include "Game.h"     //for predefined Variables
#include "screen.h"     //for predefined Variables
        ...
        if (choice.compare("S") != 0 && choice.compare("s") != 0 && choice.compare("m") != 0 && choice.compare("M") != 0){
            ...
            if (choice.compare("S") == 0 || choice.compare("s") == 0){
                ...
                do{
                    ...
                    //toast a message asking for difficulty
